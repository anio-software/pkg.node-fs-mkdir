...
export const config: unknown = defineConfig({
	...
	autogeneratedFiles: [
		...generateFactoryWithInstantiationFile({
			source: "project/src/__mkdirXXX.as.ts",
			destination: "project/export/__mkdirXXXFactory.as.ts"
		}),
		...generateFactoryWithInstantiationFile({
			source: "project/src/__mkdirpXXX.as.ts",
			destination: "project/export/__mkdirpXXXFactory.as.ts"
		})
	]
})
